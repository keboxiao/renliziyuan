		...
		if (rows.length > 0) {
			$.messager.confirm('确认', '您是否要审批当前选中的项目？', function(r) {
				if (r) {
					...
					$.ajax({
					type: 'POST',
						url : '${pageContext.request.contextPath}/xinzengshenhe.action',
						data : {
							ids : ids.join(','),
							csyj : $('#csyj').val()
						},
...
body {
	...
	<body align="center">
		...
		<div id="tb" style="padding: 3px"
			...
			<form id="shenheForm">
				初审意见：
				<input id="csyj" style="width:300px;height:60px" class="easyui-textbox" name="csyj" data-options="multiline:true"/>
